...
public class LocationRecyclerViewAdapter extends RecyclerView.Adapter<LocationRecyclerViewAdapter.RecyclerHolder>{
    List<LocationsOfPokemon> pokemons;
    Context context;


    public LocationRecyclerViewAdapter(Context context , List<LocationsOfPokemon> pokemons) {
    ...
    public void onBindViewHolder(@NonNull RecyclerHolder holder, final int position) {
        final LocationsOfPokemon pokemon = pokemons.get(position);
        holder.textView.setText(pokemons.get(position).getLocationName());
